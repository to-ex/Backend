...
public class QBaseEntity extends EntityPathBase<BaseEntity> {
    ...
    private static final long serialVersionUID = 758565800L;
    ...
    public final DateTimePath<java.time.LocalDateTime> deletedDt = createDateTime("deletedDt", java.time.LocalDateTime.class);
